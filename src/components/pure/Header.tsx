	...
	return (
		<header className="bg-white px-6 shadow">
			<div className="mx-auto flex h-16 max-w-6xl items-center justify-between">
				<button className="-m-1 rounded p-1 text-stone-500 transition-colors hover:bg-stone-200 hover:text-violet-600 focus:ring-2 focus:ring-stone-500">
					<MenuIcon />
				</button>
				{/* logo + nav desktop */}
				<div className="flex items-center">
					<a
						href="#"
						className="text-violet-600 duration-200 hover:rotate-6"
					>
						<ScriptIcon />
					</a>
					{/* nav desktop */}
